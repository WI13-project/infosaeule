...
// ansonsten inkl. Pfad
function bild_zu_banner_png($imgfile, $speicherordner,$bildbreite,$bildhoehe, $filenameOnly=true)
   {
   //Max. Groese des Thumbnail (Hï¿½he und Breite)
   $thumbsize = $bildbreite;
     $thumbsize_h=$bildhoehe;
   //Dateiname erzeugen
