...
<center>
                        ...
                        ?><img alt="<?php echo $arr;?>" src="<?php echo $arr[$hilfzeile]; ?>" height="100" align="middle">
                <?php }?>
                </center></td>
                <td width="90%" height="90%">
                        <center><img alt="<?php echo $arr;?>" src="<?php echo $arr[$zeile]; ?>" width="80%"  align="middle"></center>
                </td>
        </tr>
